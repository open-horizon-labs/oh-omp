...
- **Session log parsing**: Reads JSONL session logs from `~/.oh-omp/agent/sessions/`
...
- **Session logs**: `~/.oh-omp/agent/sessions/` (JSONL files)
- **Stats database**: `~/.oh-omp/stats.db` (SQLite)
