...
- default agent dir: `~/.oh-omp/agent`
- effective default file: `~/.oh-omp/agent/config.yml`
...
1. Create file in custom themes dir, e.g. `~/.oh-omp/agent/themes/my-theme.json`.
