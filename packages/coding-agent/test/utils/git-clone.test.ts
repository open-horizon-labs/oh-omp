...
// Regression coverage for the SHA-pinned plugin clone fix: `git.clone({ sha })`
// used to hardcode `--depth 1`, producing a shallow clone whose object store
// never contained non-tip commits. The subsequent `git checkout <sha>` then
// failed with "shallow clone may not contain this commit".
...
describe("git.clone with options.sha", () => {
	...
	test("checks out a non-tip SHA", async () => {
