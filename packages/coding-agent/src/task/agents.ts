...
import beancounterMd from "../prompts/agents/beancounter.md" with { type: "text" };
...
import superegoMd from "../prompts/agents/superego.md" with { type: "text" };
import taskMd from "../prompts/agents/task.md" with { type: "text" };
import verifierMd from "../prompts/agents/verifier.md" with { type: "text" };
import workstreamExpertMd from "../prompts/agents/workstream-expert.md" with { type: "text" };
...
const EMBEDDED_AGENT_DEFS: EmbeddedAgentDef[] = [
	...
	{ fileName: "beancounter.md", template: beancounterMd },
	{ fileName: "superego.md", template: superegoMd },
	{ fileName: "verifier.md", template: verifierMd },
	{ fileName: "workstream-expert.md", template: workstreamExpertMd },
	{
		fileName: "task.md",
		frontmatter: {
			name: "task",
